...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sms1 = findViewById(R.id.message1);
        sms2 = findViewById(R.id.message2);
        sms3 = findViewById(R.id.message3);
        sms4 = findViewById(R.id.message4);
        sms5 = findViewById(R.id.message5);
